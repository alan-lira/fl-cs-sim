...
def run_for_n_resources(num_resources: int,
    ...
    print("\t- Executing the experiment for {0} resources...".format(num_resources))
    ...
    for i in range(num_resources):
        ...
        base_seed += 1
    # Iterate over the number of tasks to assign for all schedulers.
    for num_tasks in range(min_tasks, max_tasks, step_tasks):
        # Print the number of tasks to schedule message.
        print("\t\tScheduling {0} tasks...".format(num_tasks))
        ...
        scheduler_name = "OLAR_Adapted"
        print("\t\t\t...using {0}...".format(scheduler_name))
        ...
        scheduler_name = "ELASTIC_Adapted"
        print("\t\t\t...using {0}...".format(scheduler_name))
        τ = inf
        α = 1
        ...
        elastic_adapted_training_accuracy = get_total_cost(training_accuracies, elastic_adapted_tasks_assignment)
        ...
        # scheduler_name = "FedAECS_Adapted"
        # print("\t\t\t...using {0}...".format(scheduler_name))
        ...
        # b_shape = (num_rounds, num_resources, len(assignment_capacities_expanded_shape[num_rounds-1][num_resources-1]))
        ...
        # fedaecs_adapted_assignment, _, _, _, _, _, _ \
        ...
        #                          "makespan": fedaecs_adapted_makespan,
        #                          "energy_consumption": fedaecs_adapted_energy_consumption,
        #                          "training_accuracy": fedaecs_adapted_training_accuracy}
        ...
        scheduler_name = "MEC_With_Accuracy"
        print("\t\t\t...using {0}...".format(scheduler_name))
        ...
        # mec_with_accuracy_training_accuracy = get_total_cost(training_accuracies, mec_with_accuracy_assignment)
        ...
        scheduler_name = "ECMTC_With_Accuracy"
        print("\t\t\t...using {0}...".format(scheduler_name))
        time_limit = inf  # Time limit in seconds (deadline).
        ...
        # ecmtc_with_accuracy_training_accuracy = get_total_cost(training_accuracies, ecmtc_with_accuracy_assignment)
...
def run_linear_costs_experiment() -> None:
    # Start message.
    print("Starting the linear cost experiment...")
    ...
    num_resources_list = [10, 25]  # [10, 25, 40, 55, 70, 85, 100]
    execution_parameters = {"min_tasks": 10,
                            "max_tasks": 100,
                            "step_tasks": 10,
    ...
    logger.finish()
    # End message.
    print("The linear cost experiment was successfully executed!")
    # Exit.
    exit(0)


if __name__ == '__main__':
    run_linear_costs_experiment()
