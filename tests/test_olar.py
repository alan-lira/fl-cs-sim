...
from schedulers.olar import olar


class TestOLAR(TestCase):

    def test_olar_on_olar_paper_example(self) -> None:
        ...
        # Solution to OLAR algorithm.
        assignment = olar(num_tasks, num_resources, time_costs, lower_limits, upper_limits)
    ...
    def test_olar_on_mc2mkp_paper_example_1(self) -> None:
        # Number of resources and tasks.
        num_resources = 3
        num_tasks = 5
        # Task assignment capacities per resource.
    ...
    def test_olar_on_mc2mkp_paper_example_2(self) -> None:
        # Number of resources and tasks.
        num_resources = 3
        num_tasks = 8
        # Task assignment capacities per resource.
