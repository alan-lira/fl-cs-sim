...
class TestMC2MKPAdapted(TestCase):

    def test_mc2mkp_adapted_on_olar_paper_example(self) -> None:
    ...
    def test_mc2mkp_adapted_on_mc2mkp_paper_example_1(self) -> None:
        # Number of resources and tasks.
        num_resources = 3
        num_tasks = 5
        # Task assignment capacities per resource.
    ...
    def test_mc2mkp_adapted_on_mc2mkp_paper_example_2(self) -> None:
        # Number of resources and tasks.
        num_resources = 3
        num_tasks = 8
        # Task assignment capacities per resource.
