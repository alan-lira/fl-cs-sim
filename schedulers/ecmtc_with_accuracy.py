...
def ecmtc_with_accuracy(num_resources: int,
    ...
    Returns
    -------
    optimal_schedule : ndarray(shape=(num_resources), int), minimal_energy_consumption : float, minimal_makespan : float, maximal_training_accuracy: float
        Optimal schedule (X*), minimal energy consumption (ΣE), minimal makespan (Cₘₐₓ), and maximal_training_accuracy (ΣW)
    """
    ...
    # Minimal makespan (Cₘₐₓ) obtained during the first optimization.
    ...
    # Return the optimal schedule (X*), the minimal energy consumption (ΣE), the minimal makespan (Cₘₐₓ), and
    # the maximal training accuracy (ΣW).
    return optimal_schedule, minimal_energy_consumption, minimal_makespan, maximal_training_accuracy
